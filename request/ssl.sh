...
clear
echo -e "\033[1;31mESCRIBE EL PUERTO SSL DE ESCUCHA(442sugerido)"
echo -e "\033[1;31mPUERTO   S S L DIRECTO"
read -p ": " portssl
clear
echo -e "\033[1;31mESCRIBE EL PUERTO LOCAL SHADOWSOCKS PYTHON(445sugerido)"
echo -e "\033[1;31mPUERTO   LOCAL"
read -p ": " portlocal
clear
echo -e "\033[1;31mESCRIBE EL PUERTO DE ESCUCHA SSL SHADOWSOCKS PYTHON(521sugerido)"
echo -e "\033[1;31mPUERTO   SSL ESCUCHA"
read -p ": " portshadow
clear
...
sleep 1
echo -e "\033[1;31mES NECESARIO REINICIAR"
sleep 2
echo -e "\033[1;33m- - ->>ⅅℐЅᏆℛℐℬUℐⅅᎾℛ  ℕℰᏆℱℛℰℰ  \033[01;34m"
sleep 1
echo -e "\033[1;33m- - ->> \033[01;34m "
sleep 1
echo -e "\033[1;33m- - ->>║▌TITAN:registered: ▌║█ \033[01;34m "
sleep 1
rm ssltls*