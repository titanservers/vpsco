...
case $opx in
	...
	exit;;
	1)
	wget -O /bin/pan_cracklib.sh https://raw.githubusercontent.com/titanservers/vpsco/master/Herramientas/Install-rev/pan_cracklib.sh > /dev/null 2>&1; chmod +x /bin/pan_cracklib.sh; pan_cracklib.sh
	break;;
	2)
	cambiopass
	break;;
